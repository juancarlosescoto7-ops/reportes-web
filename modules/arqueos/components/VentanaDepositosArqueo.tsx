...
import {
  CUENTAS_INGRESOS,
  TIPOS_INGRESO,
} from "@/modules/ingresos/domain/catalogos-ingresos";
import type { DepositoArqueoInput } from "@/modules/arqueos/services/arqueos.service";
...
import {
  ...
  obtenerFechaLocal,
  redondearMoneda,
} from "@/modules/arqueos/components/formato-arqueo";
