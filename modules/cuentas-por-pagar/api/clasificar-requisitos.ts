...
} from "@/modules/cuentas-por-pagar/domain/requisitos-documentales-cxp";
import type { ResultadoAnalisisDocumentalCxp } from "@/modules/cuentas-por-pagar/services/contextosDocumentalesCxp.service";
